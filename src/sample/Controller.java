...
public class Controller {
    ...
    @FXML private TitledPane defectsJIRAtoALM;
        ...
        @FXML public Label dJtA_statusLabel;

    @FXML public void on_dJtA_executeButton() {
        try {
            ...
            String parentID = almController.createFolder(dJtA_folderALM.getText(), "2");
            ...
            for (int i = 0; i < jsonIssues.length(); i++) {
                ...
                String testDescription =
                        "Ссылка на ошибку в JIRA: https://jira.voskhod.ru/browse/" + jsonIssues.getJSONObject(i).get("key").toString() + "\n" +
                                jsonIssues.getJSONObject(i).getJSONObject("fields").get("description").toString();
            ...
            dJtA_statusLabel.setStyle("-fx-text-fill: rgb(255,0,0)");
            dJtA_statusLabel.setText("Возникли проблемы, см. консоль");
            e.printStackTrace();
        }
        dJtA_statusLabel.setStyle("-fx-text-fill: rgb(0,255,0)");
        dJtA_statusLabel.setText("Успешно");
